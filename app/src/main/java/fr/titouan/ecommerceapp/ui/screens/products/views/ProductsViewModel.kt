...
sealed interface ProductsUiState {
    data class Success(val productsCategory: ProductsCategory) : ProductsUiState
...
class ProductsViewModel(
    ...
    var mProductsUiState: ProductsUiState by mutableStateOf(ProductsUiState.Loading)
        private set
    var mProducts: ProductsCategory? by mutableStateOf(null)
        private set
    ...
    fun getSafeProducts(categoryId: Int) {
        val mockProducts = GetSampleData.getProductsCategory(
